# BRIDL-REQ-008: Requirements Governance
...
### BRIDL-REQ-008.1: Requirement File Format

1. Requirement files MUST live under `requirements/` and use filenames matching `BRIDL-REQ-NNN-<topic>.md`.
2. Requirement files MUST begin with a top-level heading matching `# BRIDL-REQ-NNN: Title`.
...
### BRIDL-REQ-008.3: Test Traceability Comments
...
### BRIDL-REQ-008.4: Traceability Reviews
...
4. The requirements DeepSchema MUST include a filename regex that matches the `BRIDL-REQ-NNN-<topic>.md` naming style.
