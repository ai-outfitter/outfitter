// Shared helpers for resolving profiles and launching agent adapters.
...
import type { AgentAdapter, AgentLaunchContext, AgentLaunchPlan } from '../../agents/AgentAdapter.js';
...
import { loadLocalProfileSource, type LoadedProfile } from '../../profiles/ProfileLoader.js';
...
import {
  ...
  type CompositeProfileStateBaseline,
  type CompositeProfileStatePath,
  type CompositeProfileStateWriteIssue,
...
export interface ProfileLaunchDependencies {
...
export const executeProfileLaunch = async (
  input: ProfileLaunchInput,
  dependencies: ProfileLaunchDependencies = {},
...
export const loadResolvedProfile = (input: ProfileLaunchInput): ResolvedLaunchProfile => {
...
const emitLaunchSummary = (
  resolvedProfile: ResolvedLaunchProfile,
  adapterId: string,
