...
- **Automate:** [GitHub Actions](./docs/documentation/actions.md) · [Recurring runs](./docs/documentation/recurring-runs.md) · [In-cluster agents](./docs/documentation/in-cluster.md) · [Private repository agents](./docs/documentation/private-repository-agents.md) · [Hooks](./docs/documentation/hooks.md) · [State persistence](./docs/documentation/state.md)
