...
This review is being run as a DeepWork workflow quality gate for job 'deepwork_reviews', workflow 'discover_rules', step 'add_deepwork_native_reviews'.

## Work Summary

Created the top-level .deepreview file with the required built-in DeepWork native review rules prompt_best_practices and suggest_new_reviews, then validated the YAML structure.
...
- `review_id`: `"suggest_new_reviews--.deepreview--1ef446052656"`
